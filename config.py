...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6170962395 7191541193').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "Anime_Builder_bot") # without @
